...
public class PdfComparator<T extends CompareResult> {
    ...
    private void drawImage(final CountDownLatch latch, final int pageIndex,
        ...
        drawExecutor.execute(() -> {
            try {
                LOG.info("Drawing page {}", pageIndex);
                ...
                LOG.info("Enqueueing page {}.", pageIndex);
                diffExecutor.execute(() -> {
                    LOG.info("Diffing page {}", diffImage);
                    diffImage.diffImages();
                    LOG.info("DONE Diffing page {}", diffImage);
                });
                LOG.info("DONE drawing page {}", pageIndex);
